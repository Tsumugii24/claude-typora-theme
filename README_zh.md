...
这是一个 Claude 风格的 Typora 主题，包含浅色和深色两个版本，并将主题需要的字体文件打包在 `claude_fonts/` 文件夹中，安装后即可离线使用。

本项目基于 [blaxisomu/CLAUDE-Typora](https://github.com/blaxisomu/CLAUDE-Typora)，并针对字体打包、阅读体验、侧边栏控件和表格显示做了调整。
...
- **表格线显示优化**：在 Typora 编辑区中补齐表头和表身分割线。
- **更完整的 Typora 界面细节**：包含一体化窗口、侧边栏、Callout、菜单和表格工具栏等样式。
...
- 基于 Claude Typora 主题：[blaxisomu/CLAUDE-Typora](https://github.com/blaxisomu/CLAUDE-Typora)
